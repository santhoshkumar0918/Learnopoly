        ...
        {isLoading ? (
          ...
          posts?.map((post) => (
            ...
            >
              <div className="flex items-start space-x-3">
                <Avatar>
                  <AvatarImage src={post.user?.avatar_url || ""} alt={post.user?.username || "Unknown"} />
                  <span className="cursor-pointer" onClick={() => router.replace(`/profile/${post.user?.username || ""}`)} />
                </Avatar>
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-center mb-3">
                    <div className="flex items-center space-x-2">
                      <span
                        className="font-bold hover:underline cursor-pointer"
                        onClick={() => router.replace(`/profile/${post.user?.username}`)}
                      >
                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    >
                      <BookmarkIcon
                        className={`w-6 h-6 ${post.bookmarked ? 'text-yellow-500 fill-current' : ''}`}
                      />
                    </button>
                  </div>
